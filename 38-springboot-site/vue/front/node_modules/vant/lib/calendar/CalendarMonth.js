...
var import_utils2 = __toModule(require("../datetime-picker/utils"));
var import_utils3 = __toModule(require("./utils"));
var import_use = __toModule(require("@vant/use"));
var import_use_expose = __toModule(require("../composables/use-expose"));
var import_use_height = __toModule(require("../composables/use-height"));
var import_CalendarDay = __toModule(require("./CalendarDay"));
    ...
    const getBottomInfo = (dayType) => {
      if (props.type === "range") {
        ...
        if (dayType === "start-end") {
          return (0, import_utils3.t)("startEnd");
        }
      }
    };
    const renderTitle = () => {
