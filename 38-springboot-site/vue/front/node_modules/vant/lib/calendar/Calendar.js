...
var import_use_refs = __toModule(require("../composables/use-refs"));
var import_use_expose = __toModule(require("../composables/use-expose"));
...
var import_CalendarMonth = __toModule(require("./CalendarMonth"));
var import_CalendarHeader = __toModule(require("./CalendarHeader"));
const calendarProps = {
  show: Boolean,
      ...
      if (type === "range") {
        ...
        if (startDay && !endDay) {
          ...
          if (compareToStart === 1) {
            ...
            if (disabledDay) {
              select([startDay, (0, import_utils2.getPrevDay)(disabledDay)]);
            } else {
