  ...
  const {
    ...
    setup() {
      ...
      const render = () => {
        ...
        return createVNode(stdin_default$1k, mergeProps(state, attrs), null);
      };
      watch(message, (val) => {
        state.message = val;
      });
    ...
    return () => {
      ...
      return createVNode(Form, {
        ...
        default: () => {
          ...
          }, null), [[vShow, props.showArea]]), createVNode(stdin_default$1i, {
...
var stdin_default$1d = defineComponent({
  ...
  setup(props, {
    ...
    return () => createVNode(stdin_default$1e, mergeProps({
      "bem": bem$13,
      "role": "radio",
      "parent": parent,
      "checked": checked(),
...
var stdin_default$1b = defineComponent({
  ...
  setup(props, {
    ...
    const renderItem = (item, index, disabled) => {
      ...
      return createVNode(stdin_default$1c, {
        "key": item.id,
        "address": item,
        "disabled": disabled,
...
var stdin_default$10 = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      }) : [renderHeader(), (_a2 = slots["nav-bottom"]) == null ? void 0 : _a2.call(slots)], createVNode(stdin_default$11, {
...
var stdin_default$y = defineComponent({
  ...
  setup(props, {
    ...
    const renderImages = () => createVNode(Swipe, {
      ...
      default: () => [props.images.map((image) => createVNode(stdin_default$z, {
        "src": image,
        "show": props.show,
        "active": state.active,
...
var stdin_default$q = defineComponent({
  ...
  setup(props, {
    ...
    const renderKeys = () => keys.value.map((key) => {
      ...
      return createVNode(stdin_default$r, {
        "key": key.text,
        "text": key.text,
        "type": key.type,
        "wider": key.wider,
    ...
    const renderSidebar = () => {
      if (props.theme === "custom") {
        return createVNode("div", {
          "class": bem$l("sidebar")
        }, [props.showDeleteKey && createVNode(stdin_default$r, {
          "large": true,
