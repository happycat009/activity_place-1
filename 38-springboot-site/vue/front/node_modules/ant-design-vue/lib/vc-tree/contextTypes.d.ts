...
import type { IconType, Key, DataEntity, EventDataNode, DragNodeEvent, DataNode, Direction } from './interface';
...
export declare type NodeDragEventHandler = (e: MouseEvent, node: DragNodeEvent, outsideTree?: boolean) => void;
