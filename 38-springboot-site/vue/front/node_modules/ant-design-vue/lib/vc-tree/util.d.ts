 ...
 */
import type { NodeElement, Key, DataNode, DataEntity, FlattenNode, Direction, DragNodeEvent } from './interface';
...
export declare function isTreeNode(node: NodeElement): any;
...
export declare function calcDropPosition(event: MouseEvent, _dragNode: DragNodeEvent, targetNode: DragNodeEvent, indent: number, startMousePosition: {
    x: number;
    y: number;
