...
function flattenTreeData(treeNodeList, expandedKeys, fieldNames) {
  ...
  function dig(list) {
    ...
    return list.map(function (treeNode, index) {
      ...
      var flattenNode = (0, _extends2.default)((0, _extends2.default)({}, (0, _omit.default)(treeNode, [fieldTitle, fieldKey, fieldChildren])), {
...
function convertNodePropsToEventData(props) {
  ...
  var eventData = (0, _extends2.default)((0, _extends2.default)({
    dataRef: data
  }, data), {
    expanded: expanded,
    selected: selected,
