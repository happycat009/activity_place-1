...
import type { DefaultValueType, DataNode, LabelValueType, RawValueType, ChangeEventExtra, FlattenDataNode } from './interface';
export default function generate(config: {
    ...
    value: {
        type: import("vue").PropType<DefaultValueType>;
    };
    defaultValue: {
        type: import("vue").PropType<DefaultValueType>;
    };
    ...
    maxTagPlaceholder: {
        type: import("vue").PropType<(omittedValues: LabelValueType[]) => any>;
    };
    fieldNames: {
    ...
    onChange: {
        type: import("vue").PropType<(value: DefaultValueType, labelList: any[], extra: ChangeEventExtra) => void>;
    };
    onTreeExpand: {
    ...
    labelRender: {
        type: import("vue").PropType<(entity: FlattenDataNode) => any>;
    };
    onFocus: {
    ...
    onSelect: {
        type: import("vue").PropType<(value: RawValueType | LabelValueType, option: DataNode) => void>;
    };
    ...
    filterSort: {
        type: import("vue").PropType<(optionA: DataNode, optionB: DataNode) => number>;
    };
    ...
    onChange?: (value: DefaultValueType, labelList: any[], extra: ChangeEventExtra) => void;
    ...
    onSelect?: (value: RawValueType | LabelValueType, option: DataNode) => void;
    prefixCls?: string;
    direction?: "ltr" | "rtl";
    open?: boolean;
    animation?: string;
    ...
    onDeselect?: (value: RawValueType | LabelValueType, option: DataNode) => void;
    onClear?: import("../vc-select/interface/generator").OnClear;
    loading?: boolean;
    ...
    maxTagPlaceholder?: (omittedValues: LabelValueType[]) => any;
    ...
    inputValue?: string;
    filterSort?: (optionA: DataNode, optionB: DataNode) => number;
    ...
    labelRender?: (entity: FlattenDataNode) => any;
}>, {
    open: boolean;
    multiple: boolean;
    disabled: boolean;
