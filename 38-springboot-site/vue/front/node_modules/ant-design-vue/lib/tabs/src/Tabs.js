...
function parseTabList(children) {
  return children.map(function (node) {
    if ((0, _propsUtil.isValidElement)(node)) {
      var props = (0, _extends2.default)({}, node.props || {});
  ...
  setup: function setup(props, _ref) {
    ...
    var _useMergedState = (0, _useMergedState5.default)(function () {
      ...
      defaultValue: props.defaultActiveKey
        ...
        _useMergedState2 = (0, _slicedToArray2.default)(_useMergedState, 1),
        activeKey = _useMergedState2[0];

    var mergedActiveKey = (0, _vue.ref)();
    ...
    (0, _vue.watchEffect)(function () {
      ...
      if (newActiveIndex === -1) {
        ...
        mergedActiveKey.value = (_a = props.tabs[newActiveIndex]) === null || _a === void 0 ? void 0 : _a.key;
      } else {
    ...
    return function () {
      ...
      if (type === 'editable-card') {
        editable = {
          ...
          removeIcon: function removeIcon() {
            return (0, _vue.createVNode)(_iconsVue.CloseOutlined, null, null);
          },
          addIcon: slots.addIcon ? slots.addIcon : function () {
            return (0, _vue.createVNode)(_iconsVue.PlusOutlined, null, null);
          },
      ...
      var tabNavBar;
      var tabNavBarProps = (0, _extends2.default)((0, _extends2.default)({}, sharedProps), {
...
var _default = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref3) {
    ...
    return function () {
      ...
      var tabs = parseTabList((0, _propsUtil.flattenChildren)((_a = slots.default) === null || _a === void 0 ? void 0 : _a.call(slots)));
      return (0, _vue.createVNode)(InternalTabs, (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({}, props), attrs), {}, {
