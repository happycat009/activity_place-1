...
function createTimePicker(generateConfig) {
  var DatePicker = (0, _generatePicker.default)(generateConfig, (0, _extends2.default)((0, _extends2.default)({}, timePickerProps), {
    order: {
      type: Boolean,
      default: true
    }
  ...
  var TimePicker = (0, _vue.defineComponent)({
    ...
    setup: function setup(props, _ref) {
      ...
      return function () {
        ...
        return (0, _vue.createVNode)(InternalTimePicker, (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({}, attrs), restProps), {}, {
          "id": id,
  ...
  TimePicker.props = (0, _extends2.default)((0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, (0, _props.commonProps)()), (0, _props.datePickerProps)()), timePickerProps), {
    addon: {
      type: Function
    }
  });
  var TimeRangePicker = (0, _vue.defineComponent)({
    ...
    emits: ['change', 'panelChange', 'ok', 'openChange', 'update:value', 'update:open', 'calendarChange', 'focus', 'blur'],
    setup: function setup(props, _ref2) {
      ...
      return function () {
        ...
        return (0, _vue.createVNode)(InternalRangePicker, (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({}, attrs), restProps), {}, {
          "id": id,
          "dropdownClassName": props.popupClassName,
          "picker": "time",
          "mode": undefined,
  ...
  TimeRangePicker.props = (0, _extends2.default)((0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, (0, _props.commonProps)()), (0, _props.rangePickerProps)()), timePickerProps), {
    order: {
      type: Boolean,
      default: true
    }
