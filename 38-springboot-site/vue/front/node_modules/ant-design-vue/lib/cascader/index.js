...
var Cascader = (0, _vue.defineComponent)({
  ...
  render: function render() {
    ...
    var className = extraAttrs.class,
        ...
        _extraAttrs$id = extraAttrs.id,
        id = _extraAttrs$id === void 0 ? this.formItemContext.id.value : _extraAttrs$id,
        restAttrs = __rest(extraAttrs, ["class", "style", "id"]);
    ...
    var cascaderProps = (0, _extends2.default)((0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, props), {
      ...
      transitionName: (0, _transition.getTransitionName)(rootPrefixCls, 'slide-up', props.transitionName)
    });
