import type { PropType, ExtractPropTypes, UnwrapRef, Plugin, WatchStopHandle } from 'vue';
...
declare const setGlobalConfig: (params: GlobalConfigProviderProps) => void;
...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            componentSize?: SizeType;
            virtual?: boolean;
        }> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "dropdownMatchSelectWidth" | "notUpdateGlobalConfig">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
