...
var _Context = require("../../vc-tree-select/Context");
...
var SingleSelector = (0, _vue.defineComponent)({
  ...
  setup: function setup(props) {
    ...
    var treeSelectContext = (0, _Context.useInjectTreeSelectContext)();
    ...
    return function () {
      ...
      }, [titleNode])]), !item && !hasTextInput.value && (0, _vue.createVNode)("span", {
