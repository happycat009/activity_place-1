...
export declare const UploadDragger: import("vue").DefineComponent<{
    ...
    "onUpdate:fileList"?: (files: import("./interface").UploadFile<any>[]) => void;
}>, {
    height: number;
    prefixCls: string;
    name: string;
...
declare const _default: {
    new (...args: any[]): {
        ...
        $data: {
            sFileList: import("./interface").UploadFile<any>[];
            dragState: string;
        };
        $props: Partial<{
            height: number;
            ...
            onDownload?: (file: import("./interface").UploadFile<any>) => void;
            "onUpdate:fileList"?: (files: import("./interface").UploadFile<any>[]) => void;
        }> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "height" | "prefixCls" | "name" | "remove" | "id" | "previewFile" | "headers" | "accept" | "beforeUpload" | "customRequest" | "transformFile">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        sFileList: {
            ...
            url?: string;
            status?: import("./interface").UploadFileStatus;
            percent?: number;
            thumbUrl?: string;
            originFileObj?: any;
            response?: any;
