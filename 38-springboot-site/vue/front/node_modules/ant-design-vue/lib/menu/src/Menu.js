  ...
  setup: function setup(props, _ref) {
    ...
    var getChildrenKeys = function getChildrenKeys() {
      ...
      eventKeys.forEach(function (eventKey) {
        ...
        keys.push.apply(keys, [key].concat((0, _toConsumableArray2.default)(getChildrenKeys(childrenEventKeys))));
      });
      return keys;
    }; // ========================= Open =========================
    ...
    return function () {
      ...
      return (0, _vue.createVNode)(_vue.Fragment, null, [(0, _vue.createVNode)(_vcOverflow.default, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, attrs), {}, {
