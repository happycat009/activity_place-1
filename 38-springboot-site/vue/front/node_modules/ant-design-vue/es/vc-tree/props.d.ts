...
import type { DataNode, Key, FlattenNode, DataEntity, EventDataNode, Direction, FieldNames } from './interface';
...
export declare const nodeListProps: {
    ...
    keyEntities: {
        type: PropType<Record<Key, DataEntity>>;
    };
    dragging: {
        type: PropType<boolean>;
    };
...
export declare const treeProps: () => {
    ...
    draggable: {
        type: PropType<boolean | ((node: DataNode) => boolean)>;
    };
    defaultExpandParent: {
        type: BooleanConstructor;
        default: any;
