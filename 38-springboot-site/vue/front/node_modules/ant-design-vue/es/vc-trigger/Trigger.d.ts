declare const _default: import("vue").DefineComponent<{
    ...
    popupTransitionName: import("vue-types").VueTypeValidableDef<string> & {
        default: string;
    };
    ...
    autoDestroy: import("vue-types").VueTypeValidableDef<boolean> & {
        default: boolean;
    };
    mobile: ObjectConstructor;
    getTriggerDOMNode: FunctionConstructor;
}, {
    vcTriggerContext: {
