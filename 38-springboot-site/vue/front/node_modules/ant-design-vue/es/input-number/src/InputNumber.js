...
export default defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var maxDecimal = computed(function () {
      return getDecimalIfValidate(props.max, props.precision, true);
    });
    var minDecimal = computed(function () {
      return getDecimalIfValidate(props.min, props.precision, false);
    });
    ...
    return function () {
      ...
      }, [_createVNode("input", _objectSpread(_objectSpread({
        "autofocus": autofocus,
        "autocomplete": "off",
        "role": "spinbutton",
        "aria-valuemin": min,
