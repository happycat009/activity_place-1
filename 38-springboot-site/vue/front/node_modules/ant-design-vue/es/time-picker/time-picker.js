...
function createTimePicker(generateConfig) {
  ...
  var TimePicker = defineComponent({
    ...
    setup: function setup(props, _ref) {
      ...
      return function () {
        ...
        return _createVNode(InternalTimePicker, _objectSpread(_objectSpread(_objectSpread({}, attrs), restProps), {}, {
          "id": id,
  ...
  TimePicker.props = _extends(_extends(_extends(_extends({}, commonProps()), datePickerProps()), timePickerProps), {
    addon: {
      type: Function
    }
  });
  var TimeRangePicker = defineComponent({
    ...
    setup: function setup(props, _ref2) {
      ...
      return function () {
        ...
        return _createVNode(InternalRangePicker, _objectSpread(_objectSpread(_objectSpread({}, attrs), restProps), {}, {
          "id": id,
          "dropdownClassName": props.popupClassName,
          "picker": "time",
          "mode": undefined,
  ...
  TimeRangePicker.props = _extends(_extends(_extends(_extends({}, commonProps()), rangePickerProps()), timePickerProps), {
    order: {
      type: Boolean,
      default: true
    }
