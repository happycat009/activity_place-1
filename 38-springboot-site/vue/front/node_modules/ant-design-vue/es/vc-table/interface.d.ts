...
export declare type TransformCellText<RecordType> = (opt: {
    text: any;
...
export declare type GetComponentProps<DataType> = (data: DataType, index?: number, column?: ColumnType<any>) => Omit<HTMLAttributes, 'style'> & {
    style?: CSSProperties;
};
declare type Component<P> = DefineComponent<P> | FunctionalComponent<P> | string;
...
export declare type PanelRender<RecordType> = (data: readonly RecordType[]) => any;
export declare type TriggerEventHandler<RecordType> = (record: RecordType, event: MouseEvent) => void;
