...
var BarView = function(_super) {
  ...
  BarView2.prototype._renderNormal = function(seriesModel, ecModel, api, payload) {
    ...
    data.diff(oldData).add(function(dataIndex) {
      ...
      var layout8 = getLayout[coord.type](data, dataIndex, itemModel);
      if (drawBackground) {
        createBackground(dataIndex);
      }
      if (!data.hasValue(dataIndex) || !isValidLayout[coord.type](layout8)) {
        return;
      }
      var isClipped = false;
      if (needsClip) {
        isClipped = clip[coord.type](coordSysClipArea, layout8);
      }
      var el = elementCreator[coord.type](seriesModel, data, dataIndex, layout8, isHorizontalOrRadial, animationModel, baseAxis.model, false, roundCap);
      if (realtimeSortCfg) {
        el.forceLabelAnimation = true;
      }
      updateStyle(el, data, dataIndex, itemModel, layout8, seriesModel, isHorizontalOrRadial, coord.type === "polar");
      if (isInitSort) {
        el.attr({
          shape: layout8
        });
      } else if (realtimeSortCfg) {
        updateRealtimeAnimation(realtimeSortCfg, animationModel, el, layout8, dataIndex, isHorizontalOrRadial, false, false);
      } else {
        initProps(el, {
          shape: layout8
      ...
      var layout8 = getLayout[coord.type](data, newIndex, itemModel);
      if (drawBackground) {
        var bgEl = void 0;
      ...
      if (!data.hasValue(newIndex) || !isValidLayout[coord.type](layout8)) {
        group.remove(el);
        return;
      }
      var isClipped = false;
      ...
      if (!el) {
        el = elementCreator[coord.type](seriesModel, data, newIndex, layout8, isHorizontalOrRadial, animationModel, baseAxis.model, !!el, roundCap);
      } else {
        saveOldStyle(el);
      }
      if (realtimeSortCfg) {
      ...
      if (!isChangeOrder) {
        updateStyle(el, data, newIndex, itemModel, layout8, seriesModel, isHorizontalOrRadial, coord.type === "polar");
      }
      if (isInitSort) {
        el.attr({
          shape: layout8
        ...
        updateRealtimeAnimation(realtimeSortCfg, animationModel, el, layout8, newIndex, isHorizontalOrRadial, true, isChangeOrder);
      } else {
        updateProps(el, {
          shape: layout8
...
var clip = {
  cartesian2d: function(coordSysBoundingRect, layout8) {
    var signWidth = layout8.width < 0 ? -1 : 1;
    var signHeight = layout8.height < 0 ? -1 : 1;
    if (signWidth < 0) {
      layout8.x += layout8.width;
      layout8.width = -layout8.width;
    }
    if (signHeight < 0) {
      layout8.y += layout8.height;
      layout8.height = -layout8.height;
    }
    var coordSysX2 = coordSysBoundingRect.x + coordSysBoundingRect.width;
    var coordSysY2 = coordSysBoundingRect.y + coordSysBoundingRect.height;
    var x = mathMax2(layout8.x, coordSysBoundingRect.x);
    var x2 = mathMin2(layout8.x + layout8.width, coordSysX2);
    var y = mathMax2(layout8.y, coordSysBoundingRect.y);
    var y2 = mathMin2(layout8.y + layout8.height, coordSysY2);
    var xClipped = x2 < x;
    var yClipped = y2 < y;
    layout8.x = xClipped && x > coordSysX2 ? x2 : x;
    layout8.y = yClipped && y > coordSysY2 ? y2 : y;
    layout8.width = xClipped ? 0 : x2 - x;
    layout8.height = yClipped ? 0 : y2 - y;
    if (signWidth < 0) {
      layout8.x += layout8.width;
      layout8.width = -layout8.width;
    }
  ...
  polar: function(coordSysClipArea, layout8) {
    var signR = layout8.r0 <= layout8.r ? 1 : -1;
    if (signR < 0) {
      var tmp = layout8.r;
      layout8.r = layout8.r0;
      layout8.r0 = tmp;
    }
    var r = mathMin2(layout8.r, coordSysClipArea.r);
    var r0 = mathMax2(layout8.r0, coordSysClipArea.r0);
    layout8.r = r;
    layout8.r0 = r0;
    var clipped = r - r0 < 0;
    if (signR < 0) {
...
var elementCreator = {
  cartesian2d: function(seriesModel, data, newIndex, layout8, isHorizontal, animationModel, axisModel, isUpdate, roundCap) {
    var rect = new Rect_default({
      shape: extend({}, layout8),
      z2: 1
    });
  ...
  polar: function(seriesModel, data, newIndex, layout8, isRadial, animationModel, axisModel, isUpdate, roundCap) {
    ...
    if (animationModel) {
      ...
      var animateTarget = {};
      sectorShape[animateProperty] = isRadial ? 0 : layout8.startAngle;
      animateTarget[animateProperty] = layout8[animateProperty];
...
function updateRealtimeAnimation(realtimeSortCfg, seriesAnimationModel, el, layout8, newIndex, isHorizontal, isUpdate, isChangeOrder) {
  var seriesTarget;
  var axisTarget;
  if (isHorizontal) {
    axisTarget = {
...
var isValidLayout = {
  cartesian2d: function(layout8) {
    return !checkPropertiesNotValid(layout8, rectPropties);
  },
  polar: function(layout8) {
    return !checkPropertiesNotValid(layout8, polarPropties);
  }
};
var getLayout = {
  cartesian2d: function(data, dataIndex, itemModel) {
    var layout8 = data.getItemLayout(dataIndex);
    var fixedLineWidth = itemModel ? getLineWidth(itemModel, layout8) : 0;
    var signX = layout8.width > 0 ? 1 : -1;
    var signY = layout8.height > 0 ? 1 : -1;
    return {
      x: layout8.x + signX * fixedLineWidth / 2,
      y: layout8.y + signY * fixedLineWidth / 2,
      width: layout8.width - signX * fixedLineWidth,
      height: layout8.height - signY * fixedLineWidth
    };
  },
  polar: function(data, dataIndex, itemModel) {
    ...
    return {
      ...
      r0: layout8.r0,
      r: layout8.r,
      startAngle: layout8.startAngle,
      endAngle: layout8.endAngle,
      clockwise: layout8.clockwise
    };
  }
};
function isZeroOnPolar(layout8) {
  return layout8.startAngle != null && layout8.endAngle != null && layout8.startAngle === layout8.endAngle;
}
...
function updateStyle(el, data, dataIndex, itemModel, layout8, seriesModel, isHorizontalOrRadial, isPolar) {
  ...
  var labelPositionOutside = isPolar ? isHorizontalOrRadial ? layout8.r >= layout8.r0 ? "endArc" : "startArc" : layout8.endAngle >= layout8.startAngle ? "endAngle" : "startAngle" : isHorizontalOrRadial ? layout8.height >= 0 ? "bottom" : "top" : layout8.width >= 0 ? "right" : "left";
...
function largePathFindDataIndex(largePath, x, y) {
  ...
  for (var i = 0, len2 = points.length / 2; i < len2; i++) {
    var ii = i * 2;
...
function createBackgroundShape(isHorizontalOrRadial, layout8, coord) {
  if (isCoordinateSystemType(coord, "cartesian2d")) {
    var rectShape = layout8;
...
function createBackgroundEl(coord, isHorizontalOrRadial, layout8) {
  var ElementClz = coord.type === "polar" ? Sector_default : Rect_default;
  return new ElementClz({
    shape: createBackgroundShape(isHorizontalOrRadial, layout8, coord),
    silent: true,
    z2: 0
  });
}
...
function adjustSingleSide(list, cx, cy, r, dir, viewWidth, viewHeight, viewLeft, viewTop, farthestX) {
  ...
  function recalculateXOnSemiToAlignOnEllipseCurve(semi) {
    ...
    for (var i2 = 0; i2 < semi.list.length; i2++) {
      ...
      item.label.x = cx + (dx2 + item.len2) * dir;
    }
  }
...
function avoidOverlap(labelLayoutList, cx, cy, r, viewWidth, viewHeight, viewLeft, viewTop) {
  ...
  for (var i = 0; i < labelLayoutList.length; i++) {
    var layout8 = labelLayoutList[i];
    var label = layout8.label;
    if (isPositionCenter(layout8)) {
      continue;
    }
    var linePoints = layout8.linePoints;
    if (linePoints) {
      var isAlignToEdge = layout8.labelAlignTo === "edge";
      var realTextWidth = layout8.rect.width;
      var targetTextWidth = void 0;
      if (isAlignToEdge) {
        if (label.x < cx) {
          targetTextWidth = linePoints[2][0] - layout8.labelDistance - viewLeft - layout8.edgeDistance;
        } else {
          targetTextWidth = viewLeft + viewWidth - layout8.edgeDistance - linePoints[2][0] - layout8.labelDistance;
        }
      } else {
        if (label.x < cx) {
          targetTextWidth = label.x - viewLeft - layout8.bleedMargin;
        } else {
          targetTextWidth = viewLeft + viewWidth - label.x - layout8.bleedMargin;
        }
      }
      if (targetTextWidth < layout8.rect.width) {
        layout8.label.style.width = targetTextWidth;
        if (layout8.labelAlignTo === "edge") {
      ...
      if (isAlignToEdge) {
        if (label.x < cx) {
          linePoints[2][0] = viewLeft + layout8.edgeDistance + realTextWidth + layout8.labelDistance;
        } else {
          linePoints[2][0] = viewLeft + viewWidth - layout8.edgeDistance - realTextWidth - layout8.labelDistance;
        }
      } else {
        if (label.x < cx) {
          linePoints[2][0] = label.x + layout8.labelDistance;
        } else {
          linePoints[2][0] = label.x - layout8.labelDistance;
        }
...
function pieLabelLayout(seriesModel) {
  ...
  for (var i = 0; i < labelLayoutList.length; i++) {
    var layout8 = labelLayoutList[i];
    var label = layout8.label;
    var labelLine = layout8.labelLine;
    var notShowLabel = isNaN(label.x) || isNaN(label.y);
    if (label) {
      label.setStyle({
        align: layout8.textAlign
      });
      if (notShowLabel) {
    ...
    if (labelLine) {
      ...
      if (notShowLabel || !linePoints) {
        ...
        limitTurnAngle(linePoints, layout8.minTurnAngle);
        limitSurfaceAngle(linePoints, layout8.surfaceNormal, layout8.maxSurfaceAngle);
        labelLine.setShape({
          points: linePoints
        });
...
var PiePiece = function(_super) {
  ...
  PiePiece2.prototype.updateData = function(data, idx, startAngle, firstCreate) {
    ...
    var itemModel = data.getItemModel(idx);
    var emphasisModel = itemModel.getModel("emphasis");
    var layout8 = data.getItemLayout(idx);
    var sectorShape = extend(getSectorCornerRadius(itemModel.getModel("itemStyle"), layout8, true), layout8);
    ...
    if (firstCreate) {
      ...
      if (animationType === "scale") {
        ...
        if (startAngle != null) {
          ...
          sector.shape.endAngle = layout8.startAngle;
          updateProps(sector, {
            shape: {
              endAngle: layout8.endAngle
            }
    ...
    var midAngle = (layout8.startAngle + layout8.endAngle) / 2;
    ...
    sector.ensureState("emphasis").shape = __assign({
      r: layout8.r + (emphasisModel.get("scale") ? emphasisModel.get("scaleSize") || 0 : 0)
    }, getSectorCornerRadius(emphasisModel.getModel("itemStyle"), layout8));
    extend(sector.ensureState("select"), {
      x: dx,
      y: dy,
      shape: getSectorCornerRadius(itemModel.getModel(["select", "itemStyle"]), layout8)
    });
    extend(sector.ensureState("blur"), {
      shape: getSectorCornerRadius(itemModel.getModel(["blur", "itemStyle"]), layout8)
    });
...
var PieView = function(_super) {
  ...
  PieView2.prototype.init = function() {
    var sectorGroup = new Group_default();
...
var LargeSymbolDraw = function() {
  ...
  LargeSymbolDraw2.prototype.incrementalPrepareUpdate = function(data) {
    ...
    if (data.count() > 2e6) {
      if (!this._incremental) {
        this._incremental = new IncrementalDisplayable_default({
          silent: true
        });
      }
...
var MapView = function(_super) {
  ...
  MapView2.prototype._renderSymbols = function(mapModel, ecModel, api) {
    ...
    originalData.each(originalData.mapDimension("value"), function(value, originalDataIndex) {
      ...
      var layout8 = originalData.getItemLayout(originalDataIndex);
      if (!layout8 || !layout8.point) {
        return;
      }
      var point = layout8.point;
      var offset = layout8.offset;
...
function mapSymbolLayout(ecModel) {
  ...
  ecModel.eachSeriesByType("map", function(mapSeries) {
    ...
    data.each(function(idx) {
      var name = data.getName(idx);
      var layout8 = data.getItemLayout(idx) || {};
      layout8.showLabel = !mapSymbolOffsets[name];
      data.setItemLayout(idx, layout8);
    });
...
var TreeView = function(_super) {
  ...
  TreeView2.prototype.render = function(seriesModel, ecModel, api) {
    ...
    var layout8 = seriesModel.get("layout");
    if (layout8 === "radial") {
  ...
  TreeView2.prototype._updateViewCoordSys = function(seriesModel) {
    ...
    data.each(function(idx) {
      var layout8 = data.getItemLayout(idx);
      if (layout8 && !isNaN(layout8.x) && !isNaN(layout8.y)) {
        points.push([+layout8.x, +layout8.y]);
      }
    });
    var min = [];
    var max = [];
...
function symbolNeedsDraw(data, dataIndex) {
  var layout8 = data.getItemLayout(dataIndex);
  return layout8 && !isNaN(layout8.x) && !isNaN(layout8.y);
}
    ...
    if (node.parentNode && node.parentNode !== virtualRoot) {
      if (!edge) {
        edge = symbolEl.__edge = new BezierCurve_default({
          shape: getEdgeShape(layout8, orient, curvature, sourceOldLayout, sourceOldLayout)
        });
      }
      updateProps(edge, {
        shape: getEdgeShape(layout8, orient, curvature, sourceLayout, targetLayout)
      }, seriesModel);
    }
  } else if (edgeShape === "polyline") {
    if (layout8 === "orthogonal") {
...
var TreeNode = function() {
  ...
  TreeNode2.prototype.setLayout = function(layout8, merge) {
    this.dataIndex >= 0 && this.hostTree.data.setItemLayout(this.dataIndex, layout8, merge);
  };
...
function calculateRootPosition(layoutInfo, rootRect, targetInfo) {
  ...
  var layout8 = targetNode.getLayout();
  if (!layout8) {
    return defaultPosition;
  }
  var targetCenter = [layout8.width / 2, layout8.height / 2];
  var node = targetNode;
  while (node) {
    var nodeLayout = node.getLayout();
...
function createGraphDataProxyMixin(hostName, dataName) {
  return {
    ...
    setLayout: function(layout8, merge) {
      this.dataIndex >= 0 && this[hostName][dataName].setItemLayout(this.dataIndex, layout8, merge);
    },
    getLayout: function() {
...
var GaugeView = function(_super) {
  ...
  GaugeView2.prototype._renderMain = function(seriesModel, ecModel, api, colorList, posInfo) {
    ...
    var angleRangeSpan = !((endAngle - startAngle) % PI22) && endAngle !== startAngle ? PI22 : (endAngle - startAngle) % PI22;
...
var FunnelPiece = function(_super) {
  ...
  FunnelPiece2.prototype._updateLabel = function(data, idx) {
    ...
    var itemModel = data.getItemModel(idx);
    var layout8 = data.getItemLayout(idx);
    var labelLayout2 = layout8.label;
    var style = data.getItemVisual(idx, "style");
...
var SankeyView = function(_super) {
  ...
  SankeyView2.prototype.render = function(seriesModel, ecModel, api) {
    ...
    graph.eachNode(function(node) {
      ...
      var rect = new Rect_default({
        shape: {
          x: dragX != null ? dragX * width : layout8.x,
          y: dragY != null ? dragY * height : layout8.y,
          width: layout8.dx,
          height: layout8.dy
        },
  ...
  SankeySeriesModel2.prototype.getInitialData = function(option, ecModel) {
    ...
    function beforeLink(nodeData, edgeData) {
      nodeData.wrapMethod("getItemModel", function(model, idx) {
        ...
        var layout8 = seriesModel.getData().getItemLayout(idx);
        if (layout8) {
          var nodeDepth = layout8.depth;
      ...
      edgeData.wrapMethod("getItemModel", function(model, idx) {
        ...
        var layout8 = edge.node1.getLayout();
        if (layout8) {
          var depth = layout8.depth;
...
function getSymbolMeta(data, dataIndex, itemModel, opt) {
  ...
  prepareBarLength(itemModel, symbolRepeat, layout8, opt, symbolMeta);
  prepareSymbolSize(data, dataIndex, layout8, symbolRepeat, symbolClip, symbolMeta.boundingLength, symbolMeta.pxSign, symbolPatternSize, opt, symbolMeta);
  prepareLineWidth(itemModel, symbolMeta.symbolScale, rotation, opt, symbolMeta);
  var symbolSize = symbolMeta.symbolSize;
  var symbolOffset = normalizeSymbolOffset(itemModel.get("symbolOffset"), symbolSize);
  prepareLayoutInfo(itemModel, symbolSize, layout8, symbolRepeat, symbolClip, symbolOffset, symbolPosition, symbolMeta.valueLineWidth, symbolMeta.boundingLength, symbolMeta.repeatCutLength, opt, symbolMeta);
  return symbolMeta;
}
function prepareBarLength(itemModel, symbolRepeat, layout8, opt, outputSymbolMeta) {
  var valueDim = opt.valueDim;
  var symbolBoundingData = itemModel.get("symbolBoundingData");
  var valueAxis = opt.coordSys.getOtherAxis(opt.coordSys.getBaseAxis());
  var zeroPx = valueAxis.toGlobalCoord(valueAxis.dataToCoord(0));
  var pxSignIdx = 1 - +(layout8[valueDim.wh] <= 0);
  var boundingLength;
  if (isArray(symbolBoundingData)) {
    ...
    boundingLength = layout8[valueDim.wh];
  }
  outputSymbolMeta.boundingLength = boundingLength;
  if (symbolRepeat) {
    outputSymbolMeta.repeatCutLength = layout8[valueDim.wh];
  }
...
function prepareSymbolSize(data, dataIndex, layout8, symbolRepeat, symbolClip, boundingLength, pxSign, symbolPatternSize, opt, outputSymbolMeta) {
  var valueDim = opt.valueDim;
  var categoryDim = opt.categoryDim;
  var categorySize = Math.abs(layout8[categoryDim.wh]);
...
function prepareLayoutInfo(itemModel, symbolSize, layout8, symbolRepeat, symbolClip, symbolOffset, symbolPosition, valueLineWidth, boundingLength, repeatCutLength, opt, outputSymbolMeta) {
  var categoryDim = opt.categoryDim;
  var valueDim = opt.valueDim;
  ...
  pathPosition[categoryDim.index] = layout8[categoryDim.wh] / 2;
  ...
  bundlePosition[categoryDim.index] = layout8[categoryDim.xy];
  bundlePosition[valueDim.index] = layout8[valueDim.xy];
  var barRectShape = outputSymbolMeta.barRectShape = extend({}, layout8);
  barRectShape[valueDim.wh] = pxSign * Math.max(Math.abs(layout8[valueDim.wh]), Math.abs(pathPosition[valueDim.index] + sizeFix));
  barRectShape[categoryDim.wh] = layout8[categoryDim.wh];
  var clipShape = outputSymbolMeta.clipShape = {};
  clipShape[categoryDim.xy] = -layout8[categoryDim.xy];
  clipShape[categoryDim.wh] = opt.ecSize[categoryDim.wh];
  clipShape[valueDim.xy] = 0;
  clipShape[valueDim.wh] = layout8[valueDim.wh];
}
  ...
  ThemeRiverView2.prototype.render = function(seriesModel, ecModel, api) {
    ...
    function process2(status, idx, oldIdx) {
      ...
      for (; j < indices.length; j++) {
        var layout8 = data.getItemLayout(indices[j]);
        var x = layout8.x;
        var y0 = layout8.y0;
        var y = layout8.y;
        points0.push(x, y0);
...
var SunburstPiece = function(_super) {
  ...
  SunburstPiece2.prototype.updateData = function(firstCreate, node, seriesModel, ecModel, api) {
    ...
    var emphasisModel = itemModel.getModel("emphasis");
    var layout8 = node.getLayout();
    var sectorShape = extend({}, layout8);
  ...
  SunburstPiece2.prototype._updateLabel = function(seriesModel) {
    ...
    var normalLabelModel = itemModel.getModel("label");
    var layout8 = this.node.getLayout();
    var angle = layout8.endAngle - layout8.startAngle;
    var midAngle = (layout8.startAngle + layout8.endAngle) / 2;
    ...
    each(DISPLAY_STATES, function(stateName) {
      ...
      if (labelPosition === "outside") {
        r = layout8.r + labelPadding;
        textAlign = midAngle > Math.PI / 2 ? "right" : "left";
      } else {
        if (!textAlign || textAlign === "center") {
          r = (layout8.r + layout8.r0) / 2;
          textAlign = "center";
        } else if (textAlign === "left") {
          r = layout8.r0 + labelPadding;
      ...
      state.x = r * dx + layout8.cx;
      state.y = r * dy + layout8.cy;
...
// node_modules/echarts/lib/chart/custom/prepare.js
