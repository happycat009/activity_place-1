...
function clientToLocal(el, e2, out2, calculate) {
  ...
  } else if (env_default.browser.firefox && env_default.browser.version < "39" && e2.layerX != null && e2.layerX !== e2.offsetX) {
    out2.zrX = e2.layerX;
    out2.zrY = e2.layerY;
...
var ZRender = function() {
  function ZRender2(id, dom, opts) {
    ...
    var handerProxy = !env_default.node && !env_default.worker ? new HandlerProxy_default(painter.getViewportRoot(), painter.root) : null;
  ...
  ZRender2.prototype.addHover = function(el) {
  };
  ZRender2.prototype.removeHover = function(el) {
  };
  ZRender2.prototype.clearHover = function() {
  };
  ...
  ZRender2.prototype.pathToImage = function(e2, dpr) {
    if (this.painter.pathToImage) {
      return this.painter.pathToImage(e2, dpr);
    }
  };
    ...
    function ExtendedClass() {
      ...
      if (!proto2.$constructor) {
        if (!isESClass(superClass)) {
          ...
          var ins = createObject(ExtendedClass.prototype, new (superClass.bind.apply(superClass, __spreadArray([void 0], args)))());
          return ins;
        }
      } else {
  ...
  ZRText2.prototype._updatePlainTexts = function() {
    ...
    for (var i = 0; i < textLines.length; i++) {
      ...
      if (fixedBoundingRect) {
        el.setBoundingRect(new BoundingRect_default(adjustTextX(subElStyle.x, style.width, subElStyle.textAlign), adjustTextY(subElStyle.y, calculatedLineHeight, subElStyle.textBaseline), style.width, calculatedLineHeight));
      }
    }
  };
...
function handleGlboalMouseOutForHighDown(dispatcher, e2, api) {
  if (!isHighDownDispatcher(dispatcher)) {
    error("param should be highDownDispatcher");
  }
  allLeaveBlur(api);
...
var Circle = function(_super) {
  ...
  Circle2.prototype.buildPath = function(ctx, shape, inBundle) {
    if (inBundle) {
...
function buildPath2(ctx, shape) {
  ...
  if (!(radius > e)) {
    ...
    ctx.moveTo(x + radius * mathCos2(startAngle), y + radius * mathSin2(startAngle));
    ctx.arc(x, y, radius, startAngle, endAngle, !clockwise);
    if (innerRadius > e) {
      ctx.moveTo(x + innerRadius * mathCos2(endAngle), y + innerRadius * mathSin2(endAngle));
...
function smoothSpline(points4, isLoop) {
  var len = points4.length;
  var ret = [];
  var distance2 = 0;
  for (var i = 1; i < len; i++) {
    distance2 += distance(points4[i - 1], points4[i]);
  }
  ...
  for (var i = 0; i < segs; i++) {
    ...
    var w = pos - idx;
    var p0 = void 0;
    var p1 = points4[idx % len];
    var p2 = void 0;
    var p3 = void 0;
    if (!isLoop) {
      p0 = points4[idx === 0 ? idx : idx - 1];
      p2 = points4[idx > len - 2 ? len - 1 : idx + 1];
      p3 = points4[idx > len - 3 ? len - 1 : idx + 2];
    } else {
      p0 = points4[(idx - 1 + len) % len];
      p2 = points4[(idx + 1) % len];
      p3 = points4[(idx + 2) % len];
    }
    var w2 = w * w;
    var w3 = w * w2;
    ret.push([
...
function buildPath3(ctx, shape, closePath) {
  ...
  if (points4 && points4.length >= 2) {
    if (smooth && smooth !== "spline") {
      ...
      if (smooth === "spline") {
        points4 = smoothSpline(points4, closePath);
      }
      ctx.moveTo(points4[0][0], points4[0][1]);
...
var tmpRichText = new Text_default();
...
var SourceManager = function() {
  ...
  SourceManager2.prototype._createSource = function() {
    ...
    if (isSeries(sourceHost)) {
      ...
      var sourceHeader = retrieve2(newMetaRawOption.sourceHeader, upMetaRawOption.sourceHeader) || null;
...
var SeriesModel = function(_super) {
  ...
  SeriesModel2.prototype._innerSelect = function(data, innerDataIndices) {
    ...
    if (selectedMode === "multiple") {
      ...
      this.option.selectedMap = (_a2 = {}, _a2[nameOrId] = true, _a2);
...
var GeoJSONRegion = function(_super) {
  ...
  GeoJSONRegion2.prototype.getBoundingRect = function() {
    var rect = this._rect;
    if (rect) {
      return rect;
    }
    var MAX_NUMBER = Number.MAX_VALUE;
    var min2 = [MAX_NUMBER, MAX_NUMBER];
    var max2 = [-MAX_NUMBER, -MAX_NUMBER];
    var min22 = [];
    var max22 = [];
    ...
    return this._rect = new BoundingRect_default(min2[0], min2[1], max2[0] - min2[0], max2[1] - min2[1]);
  };
  ...
  GeoJSONRegion2.prototype.getCenter = function() {
    return this._center;
  };
  GeoJSONRegion2.prototype.setCenter = function(center2) {
...
var GeoSVGRegion = function(_super) {
  ...
  GeoSVGRegion2.prototype.getCenter = function() {
    var center2 = this._center;
    if (!center2) {
      center2 = this._center = this._calculateCenter();
    }
    return center2;
  };
  GeoSVGRegion2.prototype._calculateCenter = function() {
...
var seriesStyleTask = {
  ...
  reset: function(seriesModel, ecModel) {
    ...
    if (!globalStyle[colorKey] || colorCallback || hasAutoColor) {
      ...
      globalStyle.fill = globalStyle.fill === "auto" || typeof globalStyle.fill === "function" ? colorPalette2 : globalStyle.fill;
      globalStyle.stroke = globalStyle.stroke === "auto" || typeof globalStyle.stroke === "function" ? colorPalette2 : globalStyle.stroke;
    }
...
var seriesSymbolTask = {
  ...
  reset: function(seriesModel, ecModel) {
    ...
    function dataEach(data2, idx) {
      ...
      hasSymbolOffsetCallback && data2.setItemVisual(idx, "symbolOffset", symbolOffset(rawValue, params));
    }
    return {
  ...
  reset: function(seriesModel, ecModel) {
    ...
    function dataEach(data2, idx) {
      ...
      if (itemSymbolOffset != null) {
        data2.setItemVisual(idx, "symbolOffset", itemSymbolOffset);
      }
  ...
  ECharts2.internalField = function() {
    ...
    updateMethods = {
      ...
      update: function(payload, updateParams) {
        ...
        if (!env_default.canvasSupported) {
          var colorArr = parse(backgroundColor2);
          backgroundColor2 = stringify(colorArr, "rgb");
          if (colorArr[3] === 0) {
    ...
    bindMouseEvent = function(zr, ecIns) {
      zr.on("mouseover", function(e2) {
        ...
        var dispatcher = findEventDispatcher(el, isHighDownDispatcher);
        if (dispatcher) {
          handleGlboalMouseOutForHighDown(dispatcher, e2, ecIns._api);
          markStatusToUpdate(ecIns);
        }
...
function intervalScaleNiceTicks(extent3, splitNumber, minInterval, maxInterval) {
  ...
  var niceTickExtent = result.niceTickExtent = [roundNumber(Math.ceil(extent3[0] / interval) * interval, precision), roundNumber(Math.floor(extent3[1] / interval) * interval, precision)];
...
var IntervalScale = function(_super) {
  ...
  IntervalScale2.prototype.getMinorTicks = function(splitNumber) {
    ...
    for (var i = 1; i < ticks.length; i++) {
      ...
      while (count < splitNumber - 1) {
        var minorTick = roundNumber2(prevTick.value + (count + 1) * minorInterval);
  ...
  IntervalScale2.prototype.getLabel = function(data, opt) {
    ...
    var dataNum = roundNumber2(data.value, precision, true);
...
function makeColumnLayout(barSeries) {
  ...
  each(barSeries, function(seriesModel) {
    ...
    var barMinWidth = parsePercent2(seriesModel.get("barMinWidth") || 1, bandWidth);
...
var LogScale = function(_super) {
  ...
  LogScale2.prototype.getTicks = function(expandToNicedExtent) {
    ...
    return map(ticks, function(tick) {
      var val = tick.value;
      var powVal = round2(mathPow(this.base, val));
...
*/
//# sourceMappingURL=chunk-GEOYZPGB.js.map
