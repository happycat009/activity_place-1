...
var RadiusAxisView = function(_super) {
  ...
  RadiusAxisView2.prototype.render = function(radiusAxisModel, ecModel) {
    ...
    var layout9 = layoutAxis(polar, radiusAxisModel, axisAngle);
    var axisBuilder = new AxisBuilder_default(radiusAxisModel, layout9);
...
function layout2(axisModel, opt) {
  ...
  layout9.position = [orient === "vertical" ? positionMap.vertical[axisPosition] : rectBound[0], orient === "horizontal" ? positionMap.horizontal[axisPosition] : rectBound[3]];
  var r = {
    horizontal: 0,
    vertical: 1
  };
  layout9.rotation = Math.PI / 2 * r[orient];
  var directionMap = {
    top: -1,
    bottom: 1,
    right: 1,
  ...
  layout9.labelDirection = layout9.tickDirection = layout9.nameDirection = directionMap[axisPosition];
  if (axisModel.get(["axisTick", "inside"])) {
    layout9.tickDirection = -layout9.tickDirection;
  }
  if (retrieve(opt.labelInside, axisModel.get(["axisLabel", "inside"]))) {
    layout9.labelDirection = -layout9.labelDirection;
  }
  var labelRotation = opt.rotate;
  labelRotation == null && (labelRotation = axisModel.get(["axisLabel", "rotate"]));
  layout9.labelRotation = axisPosition === "top" ? -labelRotation : labelRotation;
  layout9.z2 = 1;
  return layout9;
}
...
var SingleAxisView = function(_super) {
  ...
  SingleAxisView2.prototype.render = function(axisModel, ecModel, api, payload) {
    ...
    var layout9 = layout2(axisModel);
    var axisBuilder = new AxisBuilder_default(axisModel, layout9);
...
var GraphicComponentView = function(_super) {
  ...
  GraphicComponentView2.prototype._relocate = function(graphicModel, api) {
    ...
    for (var i = 0; i < elOptions.length; i++) {
      ...
      elInner.__ecGraphicWidth = parsePercent2(elInner.__ecGraphicWidthOption, isParentRoot ? apiWidth : parentElInner.__ecGraphicWidth) || 0;
      elInner.__ecGraphicHeight = parsePercent2(elInner.__ecGraphicHeightOption, isParentRoot ? apiHeight : parentElInner.__ecGraphicHeight) || 0;
    }
...
function removeEl(elExisting, elMap) {
  ...
  if (existElParent) {
    ...
    elMap.removeKey(inner5(elExisting).__ecGraphicId);
...
var SaveAsImage = function(_super) {
  ...
  SaveAsImage2.prototype.onclick = function(ecModel, api) {
    ...
    if (typeof MouseEvent === "function" && (env_default.browser.newEdge || !env_default.browser.ie && !env_default.browser.edge)) {
...
SaveAsImage.prototype.unusable = !env_default.canvasSupported;
...
var bind3 = bind;
var each6 = each;
var parsePercent3 = parsePercent2;
...
var TooltipView = function(_super) {
  ...
  TooltipView2.prototype.init = function(ecModel, api) {
    ...
    this._tooltipContent = this._renderMode === "richText" ? new TooltipRichContent_default(api) : new TooltipHTMLContent_default(api.getDom(), api, {
  ...
  TooltipView2.prototype.render = function(tooltipModel, ecModel, api) {
    ...
    this._keepShow();
    this._updatePosition = this._renderMode === "html" ? throttle(bind3(this._doUpdatePosition, this), 50) : this._doUpdatePosition;
  };
  ...
  TooltipView2.prototype._showAxisTooltip = function(dataByCoordSys, e) {
    ...
    each6(dataByCoordSys, function(itemCoordSys) {
      each6(itemCoordSys.dataByAxis, function(axisItem) {
  ...
  TooltipView2.prototype._showTooltipContent = function(tooltipModel, defaultHtml, params, asyncTicket, x, y, positionExpr, el, markupStyleCreator) {
    ...
    if (formatter) {
      if (isString(formatter)) {
        ...
        var callback = bind3(function(cbTicket, html2) {
  ...
  TooltipView2.prototype._doUpdatePosition = function(tooltipModel, positionExpr, x, y, content, params, el) {
    ...
    if (isArray(positionExpr)) {
      x = parsePercent3(positionExpr[0], viewWidth);
      y = parsePercent3(positionExpr[1], viewHeight);
  ...
  TooltipView2.prototype._updateContentNotChangedOnAxis = function(dataByCoordSys, cbParamsList) {
    ...
    contentNotChanged && each6(lastCoordSys, function(lastItemCoordSys, indexCoordSys) {
      var lastDataByAxis = lastItemCoordSys.dataByAxis || [];
      var thisItemCoordSys = dataByCoordSys[indexCoordSys] || {};
      var thisDataByAxis = thisItemCoordSys.dataByAxis || [];
      contentNotChanged = contentNotChanged && lastDataByAxis.length === thisDataByAxis.length;
      contentNotChanged && each6(lastDataByAxis, function(lastItem, indexAxis) {
        var thisItem = thisDataByAxis[indexAxis] || {};
        var lastIndices = lastItem.seriesDataIndices || [];
        var newIndices = thisItem.seriesDataIndices || [];
        contentNotChanged = contentNotChanged && lastItem.value === thisItem.value && lastItem.axisType === thisItem.axisType && lastItem.axisId === thisItem.axisId && lastIndices.length === newIndices.length;
        contentNotChanged && each6(lastIndices, function(lastIdxItem, j) {
...
var MarkAreaView = function(_super) {
  ...
  MarkAreaView2.prototype.renderSeries = function(seriesModel, maModel, ecModel, api) {
    ...
    areaData.diff(inner10(polygonGroup).data).add(function(idx) {
      var layout9 = areaData.getItemLayout(idx);
      if (!layout9.allClipped) {
        var polygon = new Polygon_default({
          shape: {
            points: layout9.points
          }
        });
      ...
      var layout9 = areaData.getItemLayout(newIdx);
      if (!layout9.allClipped) {
        if (polygon) {
          updateProps(polygon, {
            shape: {
...
var LegendView = function(_super) {
        ...
        ecModel.eachRawSeries(function(seriesModel2) {
          ...
          if (seriesModel2.legendVisualProvider) {
            ...
            if (colorArr && colorArr[3] === 0) {
              colorArr[3] = 0.2;
              style2.fill = stringify(colorArr, "rgba");
            }
  ...
  LegendView2.prototype._createSelector = function(selector2, legendModel, api, orient, selectorPosition) {
    ...
    each8(selector2, function createSelectorButton(selectorItem) {
