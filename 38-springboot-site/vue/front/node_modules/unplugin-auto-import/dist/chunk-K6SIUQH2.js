...
var vueuse_core_default = () => {
  ...
  if (!_cache) {
    try {
      const path = _localpkg.resolveModule.call(void 0, "@vueuse/core/indexes.json");
      const indexesJson = JSON.parse(_fs.readFileSync.call(void 0, path, "utf-8"));
      _cache = {
...
exports.__spreadValues = __spreadValues; exports.__spreadProps = __spreadProps; exports.presets = presets;
