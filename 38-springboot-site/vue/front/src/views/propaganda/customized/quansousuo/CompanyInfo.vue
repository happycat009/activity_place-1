  ...
  >
    ...
    <div class="info">
      ...
      <div class="tags">
        <template v-for="(item, index) in renderData.tags" :key="index">
          <div
            class="tag"
            :style="{
              color: customData.color[index % customData.color.length],
              'border-color': customData.color[index % customData.color.length],
              'background-color':
                customData.color[index % customData.color.length] + '24',
            }"
          >
            {{ item }}
          </div>
      ...
      <div class="cells">
        <div class="cell">
          <div class="icon">
            <img src="~/assets/images/propaganda/info-03.png" alt="" />
          </div>
        ...
        <div class="cell">
          <div class="icon">
            <img src="~/assets/images/propaganda/info-04.png" alt="" />
          </div>
    ...
    <button class="orange" @click="handleJumpRoute">联系我们</button>
  </div>
</template>
