  ...
  <div class="propaganda">
    <div class="container">
      ...
      <div class="con">
        ...
        <CompanyProduct v-if="customData.companyInfo.products && customData.companyInfo.products.length>0" :renderData="customData.companyInfo.products"></CompanyProduct>
        <CompanyHonor
